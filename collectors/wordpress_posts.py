...
# Dr. Eppley’s blog (WordPress) runs at exploreplasticsurgery.com
FEED_URL = "https://www.exploreplasticsurgery.com/feed/"

FIELDS = ["source","title","link","pub_date","creator","categories","summary"]
...
def run():
    ...
    try:
        ...
        for it in items:
            ...
            creator = (it.findtext("{http://purl.org/dc/elements/1.1/}creator") or "").strip()
